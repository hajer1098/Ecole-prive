...
{ 
    ...
    $query = "update eleve set id_eleve= ' $idEl',nom='$nom',prenom='$prenom',datenaissance='$naiss',adresse='$adresse' ,
...
<body>
    ...
    <form method="POST" action="Updateeleve.php">
            ...
            <table>
                ...
                <tr>
                    <td>
                        ...
                        <td><input type="date" name="datenaissance" size="15" maxlength="30" value="<?php echo $ness?>" required><br></td>
                    </td>
